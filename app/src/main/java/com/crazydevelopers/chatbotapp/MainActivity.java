...
import com.crazydevelopers.chatbotapp.Helper.HttpDataHandler;
import com.crazydevelopers.chatbotapp.Models.SimsimiModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setBackgroundDrawableResource(R.drawable.female_bot);
...
//        new SimsimiAPI().execute(list_chat);
    ...
    private void speak(String content,float pitch, float speed) {
        mTTS.setPitch(pitch);
...
//                presentChats.deleteCharAt((presentChats.toString().length())-1);
    ...
    public void showProfile(int pos){
        Intent intent;
        if(pos%2==0) {
            intent = new Intent(MainActivity.this, AphroditeProfile.class);
            speak("Awwww! You are stalking me", 1.5f, 0.75f);
        }
        else {
            intent = new Intent(MainActivity.this, ForProfile.class);
            speak("You can see Developer's details here.",1.5f,1.0f);
        }
        startActivity(intent);
    }
